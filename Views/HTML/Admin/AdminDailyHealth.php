...
if(isset($_POST["dailyhealth-student_id"])&&isset($_POST["dailyhealth-count"])){
    ...
    $sql = "select department_name from department where manager_id = '$teacher_id'";
    ...
    $sql2 = "select * from student where department_name = '$department' and student_id = '$student_id'";
